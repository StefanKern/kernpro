...
import { WordcloudComponent, WordcloudWord, WordcloudWordSize } from '../../components/wordcloud/wordcloud.component';
...
export class WordcloudTestComponent implements OnInit, OnDestroy {
  ...
  availableColors = [
    '#000000', '#FF0000', '#00FF00', '#0000FF', '#FF8C00',
    '#8A2BE2', '#DC143C', '#00CED1', '#FFD700', '#32CD32',
    '#FF1493', '#00BFFF', '#FF6347', '#9370DB', '#20B2AA'
  ];

  // Sample word pools for generating test data
  private skillWords = [
    'JavaScript', 'TypeScript', 'Angular', 'React', 'Vue.js', 'Node.js', 'Python', 'Java',
    'C#', 'C++', 'Go', 'Rust', 'Swift', 'Kotlin', 'PHP', 'Ruby', 'HTML', 'CSS', 'SASS',
    'MongoDB', 'PostgreSQL', 'MySQL', 'Redis', 'Docker', 'Kubernetes', 'AWS', 'Azure',
    'Git', 'Jenkins', 'Linux', 'Nginx', 'Apache', 'REST', 'GraphQL', 'Microservices',
    'Machine Learning', 'Data Science', 'AI', 'Deep Learning', 'TensorFlow', 'PyTorch',
    'Blockchain', 'Cybersecurity', 'DevOps', 'CI/CD', 'Agile', 'Scrum', 'Leadership'
  ];

  private industryWords = [
    'Fintech', 'Healthcare', 'E-commerce', 'Gaming', 'EdTech', 'SaaS', 'Automotive',
    'Aerospace', 'Telecommunications', 'Banking', 'Insurance', 'Retail', 'Manufacturing',
    'Energy', 'Real Estate', 'Media', 'Entertainment', 'Sports', 'Travel', 'Food'
  ];

  private conceptWords = [
    'Innovation', 'Scalability', 'Performance', 'Security', 'Reliability', 'Usability',
    'Accessibility', 'Responsiveness', 'Optimization', 'Integration', 'Automation',
    'Analytics', 'Monitoring', 'Testing', 'Documentation', 'Collaboration', 'Communication',
    'Problem Solving', 'Critical Thinking', 'Creativity', 'Adaptability', 'Teamwork'
  ];
  ...
  randomizeColors() {
    this.words.update(current => current.map(word => ({
      ...word,
      color: this.getRandomColor()
    })));
